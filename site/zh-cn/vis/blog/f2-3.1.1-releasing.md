<!--
index: 9
title: F2 3.1 发布，开箱即用的移动端图表解决方案
authors:
  - name: 再飞、画康、御术
...
__F2，源于 Fast & Flexible 两个单词首字母__，是 AntV 家族中专为移动端定制、开箱即用的可视化图表解决方案。
...
哐～～～ 晴天一声巨响，经过将近九九八十一天潜心修炼，现在我正式以『**F2**』为名向大家自荐，我将以 **Fast & Flexible** 为行事准则，力求将自己打造成一套『开箱即用的移动端图表解决方案』。
