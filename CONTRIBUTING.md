...
If you have any comment or advice, please report your [issue](https://github.com/antvis/site/issues),
or make any change as you wish and submit an [PR](https://github.com/antvis/site/pulls).
...
Then you can create a Pull Request at [site](https://github.com/antvis/site/pulls).
...
4. User Tips: Notice for AntV users. You can skip this part, if the PR is not about update in API or potential compatibility problem.
...
Document change on antvis/site#123
...
antvis/site uses semantic versioning in release process based on [semver].
